...
public class Databasehelper extends SQLiteOpenHelper {
    ...
    public Databasehelper(Context context) {
        super(context, "veritutar9", null, 6);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE holder(processid INTEGER PRIMARY KEY AUTOINCREMENT,type TEXT,info TEXT,day INTEGER,month INTEGER,year INTEGER,price DOUBLE,repeat TEXT,label TEXT,pricetype TEXT,taksit INTEGER,taksitcounter INTEGER);");
