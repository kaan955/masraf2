...
public class myadapter extends AppCompatActivity {
    ...
    private BasitRVAdapter adapter,adapter2,adapter3,adapter4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new BasitRVAdapter(this, dataveriler,dataveriler2,dataveriler3,dataveriler4);
    ...
    public void veriYukle(){
        ...
        if (c.getCount() <= 0) {
            ...
            do {
                ...
                dataveriler2.add("" + c.getString(c.getColumnIndex("info")));
                dataveriler3.add("₺" + String.format("%.2f", c.getDouble(c.getColumnIndex("price"))));
